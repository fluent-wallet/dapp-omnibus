import { store, connect, sendTransaction, watchAsset, addChain, switchChain, typedSign, Unit, useBalance } from '@cfxjs/use-wallet-react/ethereum/Fluent';
import { WalletProvider, Status } from '../../AccountManage/types';

const walletProvider = {
  walletName: 'Fluent-Ethereum',
